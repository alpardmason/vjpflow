...
:mod:`vjpflow.tensor` is backend-agnostic; only :meth:`Primitive.forward
<vjpflow.primitives.Primitive.forward>` ever touches a backend.
...
Metal is a one-line change (:func:`vjpflow.backends.set_default_backend`) with
